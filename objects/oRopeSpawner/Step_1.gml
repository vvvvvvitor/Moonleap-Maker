if (!init) {
    offset = 8;
    head   = self;
    next   = instance_create_layer(x, y + offset, layer, oRopeSegment);
    ...
    physics_joint_set_value(attach, phy_joint_max_length, 0.8);
    ...
    repeat (ROPE_LENGTH) {
        ...
        tail = next;
        next = instance_create_layer(x, y+16 + offset, layer, oRopeSegment);
        ...
        physics_joint_set_value(link, phy_joint_max_length, 0.8);        
