...
if debug_mode=false {instance_destroy()}
...
history_count_max = 10				// how much history do you want saved 
...
pos_height = 300/3 // how tall the history area is (the textbox starts after this)
pos_margin_sides = 24/3 // how far away from the sides the box should be 
pos_inner_padding_sides = 20/3 // how much room should there be between the text and the side of the box
pos_inner_padding_bottom = 25/3 // this is how much room is between the bottom of the text area and the bottom text line
main_area_height = 40/2 // the height of the text area 
main_area_inner_padding_sides = 50/2 // how far away from the left side the text starts on the main area 
history_line_height = 24/3
predict_line_height = 22/3
view_bottom_margin = 800/3
view_bottom_padding = 10/3
view_left_margin = 850	/3
view_left_padding = 60	/3
view_data_height = 32	/3
view_data_width = 110	/3
view_each_height = 50	/3
#endregion
#region animations 
display_frames = 27
display_frame = 0
...
predict_grow_speed = 74/2 // in px
predict_shrink_speed = 53/2 // in px
