...
draw_self_perfect()
draw_sprite(sGiantPortalOverlay,overlay_index,x,y)

draw_sprite_ext(sPortalRank,rank1,x-12,y-24,abs(image_xscale),1,0,c_white,1)
draw_sprite_ext(sPortalRank,rank2,x-4,y-24,abs(image_xscale),1,0,c_white,1)
draw_sprite_ext(sPortalRank,rank3,x+4,y-24,abs(image_xscale),1,0,c_white,1)
draw_sprite_ext(sPortalRank,rank4,x+12,y-24,abs(image_xscale),1,0,c_white,1)

if opensprite=true
{draw_sprite(sGiantPortalOpen,open_index,x,y)}