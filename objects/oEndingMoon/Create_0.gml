...
if porcentagem>=119 {porcentagem=120}
...
if(porcentagem >= 120)
{
	sprite_index=sEndingTrue
	if instance_exists(oCreditsFlash) { oCreditsFlash.sprite_index=sFinaltransTrue }
	
	if perfect_levels>=64
	{
		sprite_index=sEnding1000
		if instance_exists(oCreditsFlash) { oCreditsFlash.sprite_index=sFinaltransTrue }
...
if  global.settings.deaths<2
{
	sprite_index=sEndingSuperTrue
	if instance_exists(oCreditsFlash) { oCreditsFlash.sprite_index=sFinaltransSuperTrue }
}
...
if(oSaveManager.struct_main[$ "r51"] > 0){
	total_level += 1;
}

if(oSaveManager.struct_main[$ "r54"] > 0){
	total_level += 1;
}

if(oSaveManager.struct_main[$ "r55"] > 0){
	total_level += 1;
}

if(oSaveManager.struct_main[$ "r58"] > 0){
	total_level += 1;
}

if(oSaveManager.struct_main[$ "r58"] == 1){
	total_pombos += 1;
}
...
levels_existentes = 44;
secrets_existentes = 4;
specials_existentes = 4;
pombos_existentes = 10;
