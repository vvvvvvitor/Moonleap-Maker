if drawy!=y {drawy=smooth_approach(drawy,y,0.1)}
	...
	if level_index=0 and myloadvalue<0.5
...
if opensprite=true
{
	if open=true
	{
	if open_index=open_number-15 {audio_play_sfx(snd_porta_abre,false,-18,7)}
...
draw_self_perfect()
	...
	draw_sprite_ext(sPortalOverlay,overlay_index,x,y,image_xscale,1,0,c_white,1)
	draw_sprite_ext(sPortalRank,rank,x,y,abs(image_xscale),1,0,c_white,1)
...
if opensprite=true
{draw_sprite_ext(sPortalopen,open_index,x,y,image_xscale,1,0,c_white,1)}